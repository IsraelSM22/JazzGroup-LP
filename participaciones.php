...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">
            <img src="https://getbootstrap.com/docs/4.0/assets/brand/bootstrap-solid.svg" width="30" height="30" alt="Jazz Group">
        </a>
        ...
        <div class="navbar-collapse collapse w-100" id="navbarSupportedContent">
            <ul class="nav navbar-nav ml-auto w-100 justify-content-end">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="participaciones.php">Participaciones</a>
                </li>
                <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="stackla-widget" data-alias="airfrance.stackla.com" data-ct="" data-hash="5c473eb0ecf15"
                        data-id="51983" data-title="Social Wall Mexico" data-ttl="30" style="width: 100%; overflow: hidden;"></div>
